...
export const Contact = () => {
    return (
        <section 
            ...
            />
            <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center w-[90vw] min-h-[80vh]">
                <Container className="w-full backdrop-blur-md p-6 md:p-8">
                        ...
                        {ContactItems.map((item, i) => (
                            ...
                            >
                                ...
                                <input 
                                    ...
                                    className="w-full p-3 bg-gray-300/50 outline-none rounded-md focus:ring-1 focus:ring-black"
                    ...
                    <div className="mt-6 flex justify-center">
                        <Button onClick={() => "#"} className="w-1/2">Submit</Button>
                    </div>
                </Container>
            </div>
        </section>
